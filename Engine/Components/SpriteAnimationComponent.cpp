...
namespace nc
{
	bool SpriteAnimationComponet::Create(void* data)
	{
		m_owner = static_cast<GameObject*>(data);
		return true;
	}

	void SpriteAnimationComponet::Destroy()
	{
	}

	void SpriteAnimationComponet::Read(const rapidjson::Value& value)
	{
	...
	void SpriteAnimationComponet::Update()
	{
